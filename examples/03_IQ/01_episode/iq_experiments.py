...
from imitation_lib.imitation import IQ_SAC
...
def _create_agent(mdp, expert_data, sw, lr_critic, lr_actor, plcy_loss_mode,
                  regularizer_mode, use_target, use_cuda, tau, learnable_alpha, 
                  init_alpha, reg_mult, gamma, log_std_min, log_std_max, delay_Q, 
                  n_fits, logging_iter):
    ...
    # create IQ agent
    agent = IQ_SAC(mdp_info=mdp.info, batch_size=batch_size, initial_replay_size=initial_replay_size,
                 ...
                 reg_mult=reg_mult, log_std_min=log_std_min, log_std_max=log_std_max, n_fits=n_fits, 
...
def experiment(env_id: str = "HalfCheetah-v2",
    ...
    agent = _create_agent(mdp, expert_data,  sw=tb_writer, lr_critic=lr_critic, lr_actor=lr_actor,
                          ...
                          use_cuda=use_cuda, use_target=use_target, delay_Q=delay_Q, tau=tau, 
                          learnable_alpha=learnable_alpha, init_alpha=init_alpha,
                          reg_mult=reg_mult, gamma=gamma, log_std_min=log_std_min,
